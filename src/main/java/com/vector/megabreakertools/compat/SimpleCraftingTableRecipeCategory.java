...
import com.vector.megabreakertools.recipe.SimpleCraftingTableRecipe;
...
public class SimpleCraftingTableRecipeCategory implements IRecipeCategory<SimpleCraftingTableRecipe> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("megabreakertools", "textures/gui/simple_crafting_table/simple_crafting_table_gui_jei.png");
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("megabreakertools", "simple_crafting_table");
    ...
    public Component getTitle() {
        return Component.translatable("block.megabreakertools.simple_crafting_table");
    }

...
public class UltraCraftingTableRecipeCategory implements IRecipeCategory<UltraCraftingTableRecipe> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("megabreakertools", "textures/gui/ultra_crafting_table/ultra_crafting_table_gui_jei.png");
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("megabreakertools", "ultra_crafting_table");

...
public class AdvancePickaxeItem extends DiggerItem implements IModeSwitchable {
    public AdvancePickaxeItem(Tier pTier, Properties pProperties) {
        super(pTier, BlockTags.MINEABLE_WITH_PICKAXE, pProperties);
    }

    @Override
    public int getRange() {
        return 2; /// 5x5 (range=2)
    }

    @Override
    public boolean is3DMining() {
        return false; /// false = 5x5 = 2D, true = 5x5x5 = 3D
    }

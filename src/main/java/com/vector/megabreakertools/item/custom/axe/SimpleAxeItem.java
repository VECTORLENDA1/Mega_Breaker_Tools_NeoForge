...
public class SimpleAxeItem extends DiggerItem {
    public SimpleAxeItem(Tier pTier, Properties pProperties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        for (BlockPos pos : targets) {
            ...
            // tentar strip/scrape/wax-off na ordem padrão
        ...
        if (changedAny) {
            // tocar um som coerente com a ação no bloco original

...
public class LegendaryAxeItem extends DiggerItem implements IModeSwitchable {
    public LegendaryAxeItem(Tier pTier, Properties pProperties) {
        super(pTier, BlockTags.MINEABLE_WITH_AXE, pProperties);
    }

    @Override
    public int getRange() {
        return 5; /// 11x11 area (range=5)
    }

...
public class MegaSimpleLumberjackItem extends DiggerItem implements IModeSwitchable{
    public MegaSimpleLumberjackItem(Tier pTier, Properties pProperties) {
        super(pTier, BlockTags.MINEABLE_WITH_AXE, pProperties);
    }

    @Override
    public int getRange() {
        return 1; /// 3x3x3 area (range=1)
    }

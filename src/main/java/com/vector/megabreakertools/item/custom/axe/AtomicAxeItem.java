...
public class AtomicAxeItem extends DiggerItem implements IModeSwitchable {
    public AtomicAxeItem(Tier pTier, Properties pProperties) {
        super(pTier, BlockTags.MINEABLE_WITH_AXE, pProperties);
    }

    @Override
    public int getRange() {
        return 6; /// 13x13 area (range=6)
    }

...
public class UltimateAxeItem extends DiggerItem implements IModeSwitchable {
    public UltimateAxeItem(Tier pTier, Properties pProperties) {
        super(pTier, BlockTags.MINEABLE_WITH_AXE, pProperties);
    }

    @Override
    public int getRange() {
        return 4; /// 9x9 area (range=4)
    }

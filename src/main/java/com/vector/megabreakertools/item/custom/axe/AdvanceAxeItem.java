...
public class AdvanceAxeItem extends DiggerItem implements IModeSwitchable {
    public AdvanceAxeItem(Tier pTier, Properties pProperties) {
        super(pTier, BlockTags.MINEABLE_WITH_AXE    , pProperties);
    }

    @Override
    public int getRange() {
        return 2; /// 5x5 area (range=2)
    }

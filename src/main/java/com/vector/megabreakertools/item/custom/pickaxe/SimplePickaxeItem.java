...
public class SimplePickaxeItem extends DiggerItem implements IModeSwitchable {

    public SimplePickaxeItem(Tier pTier, Properties pProperties) {
        super(pTier, BlockTags.MINEABLE_WITH_PICKAXE, pProperties);
    }

    @Override
    public int getRange() {
        return 1; /// 3x3 (range=1)
    }

    @Override
    public boolean is3DMining() {
        return false; /// false = 3x3 = 2D, true = 3x3x3 = 3D
    }

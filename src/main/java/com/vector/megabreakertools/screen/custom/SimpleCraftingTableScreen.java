package com.vector.megabreakertools.screen.custom;
...
public class SimpleCraftingTableScreen extends AbstractContainerScreen<SimpleCraftingTableMenu> {
    public static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath("megabreakertools","textures/gui/simple_crafting_table/simple_crafting_table_gui.png");

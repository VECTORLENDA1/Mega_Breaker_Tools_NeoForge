package com.vector.megabreakertools.worldgen;
...
public class ModBiomeModifiers {
    ...
    public static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(ForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(MegaBreakerTools.MODID, name));
    }
}
